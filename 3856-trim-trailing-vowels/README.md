<h2><a href="https://leetcode.com/problems/trim-trailing-vowels/?envType=problem-list-v2&envId=v3iu6n4d">4229. Trim Trailing Vowels</a></h2><h3>Easy</h3><hr><p>You are given a string <code>s</code> that consists of lowercase English letters.</p>
